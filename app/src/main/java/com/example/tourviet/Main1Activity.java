...
public class Main1Activity extends AppCompatActivity {
    ...
    private void Anhxa() {
        editAddressdk = findViewById(R.id.dangki_Address);
        editPassdk = findViewById(R.id.dangki_Pass);
        editEmaildk = findViewById(R.id.dangki_email);
        editHo_tendk = findViewById(R.id.dangki_Ho_Ten);
        editSDTdk = findViewById(R.id.dangki_SDT);
        editDatedk = findViewById(R.id.dangki_Date);
        editPhaidk = findViewById(R.id.dangki_Phai);
        buttonDangKi = findViewById(R.id.buttonDangKi_dangki);
        buttonHuy = findViewById(R.id.buttonDangKi_huy);
